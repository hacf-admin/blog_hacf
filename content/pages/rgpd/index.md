...
Au début de l'aventure, nous avions réfléchis à plusieurs sources de financement :
* ~~Publicités~~,
* Dons,
* Liens affiliés,
...
### Publicités
Nous sommes des utilisateurs du web comme vous et nous ne sommes pas favorable à l'invasion de votre écran par de la publicité en tous genres, toutes les trois lignes d'article.
De plus nous ne contrôlons pas forcement le type de publicité diffusé.
...
>Actuellement, seul notre [plateforme discord](https://discord.hacf.fr) permet de générer les liens affiliés, mais il est possible en cliquant sur les liens ci-dessous d'accèder à l'"accueil affilié" des deux marchands.
...
{{< button "Liens Affilliés" "https://amazon.hacf.fr" "fab fa-amazon">}}
